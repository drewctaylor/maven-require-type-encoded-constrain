...
/**
 * A 7-parameter effect that may throw an exception.
 * 
...
public interface E7E<P1, P2, P3, P4, P5, P6, P7, E extends Exception>
{
     ...
     */
    default E7E<P7, P6, P5, P4, P3, P2, P1, E> reverse()
    {
        return (
                p7,
                p6,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, E1E<P7, E>>>>>>> curry()
    {
    ...
    static <P1, P2, P3, P4, P5, P6, P7, E extends Exception> E7E<P1, P2, P3, P4, P5, P6, P7, E> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, E1E<P7, E>>>>>>> f1)
    {
