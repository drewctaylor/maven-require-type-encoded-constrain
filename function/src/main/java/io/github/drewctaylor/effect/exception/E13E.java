...
/**
 * A 13-parameter effect that may throw an exception.
 * 
...
public interface E13E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, E extends Exception>
{
     ...
     */
    default E13E<P13, P12, P11, P10, P9, P8, P7, P6, P5, P4, P3, P2, P1, E> reverse()
    {
        return (
                p13,
                p12,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, F1<P11, F1<P12, E1E<P13, E>>>>>>>>>>>>> curry()
    {
    ...
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, E extends Exception> E13E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, E> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, F1<P11, F1<P12, E1E<P13, E>>>>>>>>>>>>> f1)
    {
