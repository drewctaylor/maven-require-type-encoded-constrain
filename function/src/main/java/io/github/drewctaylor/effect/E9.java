...
public interface E9<P1, P2, P3, P4, P5, P6, P7, P8, P9>
{
     ...
     * 
     * @throws NullPointerException if e9 is null
     */
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9> E9<P1, P2, P3, P4, P5, P6, P7, P8, P9> nop()
    {
        return (
                p1,
                p2,
     ...
     */
    default E8<P2, P3, P4, P5, P6, P7, P8, P9> a(
            final P1 p1)
    {
        return (
                p2,
     ...
     */
    default E9<P9, P8, P7, P6, P5, P4, P3, P2, P1> reverse()
    {
        return (
                p9,
                p8,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, E1<P9>>>>>>>>> curry()
    {
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9> E9<P1, P2, P3, P4, P5, P6, P7, P8, P9> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, E1<P9>>>>>>>>> f1)
    {
