...
/**
 * A 6-parameter effect that may throw an exception.
 * 
...
public interface E6E<P1, P2, P3, P4, P5, P6, E extends Exception>
{
     ...
     * 
     * @throws NullPointerException if e6e is null
     */
     ...
     */
    static <P1, P2, P3, P4, P5, P6, E extends Exception> E6E<P1, P2, P3, P4, P5, P6, E> nop()
    {
        return (
                p1,
                p2,
     ...
     */
    default E5E<P2, P3, P4, P5, P6, E> a(
            final P1 p1)
    {
        return (
                p2,
     ...
     */
    default E6E<P6, P5, P4, P3, P2, P1, E> reverse()
    {
        return (
                p6,
                p5,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, E1E<P6, E>>>>>> curry()
    {
     ...
     */
    static <P1, P2, P3, P4, P5, P6, E extends Exception> E6E<P1, P2, P3, P4, P5, P6, E> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, E1E<P6, E>>>>>> f1)
    {
     ...
     */
    static <P1, P2, P3, P4, P5, P6, E extends Exception> E6E<P1, P2, P3, P4, P5, P6, E> e(
            final E e)
    {
        requireNonNull(e, "e");
        return (
