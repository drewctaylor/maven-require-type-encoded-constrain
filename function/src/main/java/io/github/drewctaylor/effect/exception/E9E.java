...
/**
 * A 9-parameter effect that may throw an exception.
 * 
...
public interface E9E<P1, P2, P3, P4, P5, P6, P7, P8, P9, E extends Exception>
{
     ...
     */
    default E9E<P9, P8, P7, P6, P5, P4, P3, P2, P1, E> reverse()
    {
        return (
                p9,
                p8,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, E1E<P9, E>>>>>>>>> curry()
    {
    ...
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, E extends Exception> E9E<P1, P2, P3, P4, P5, P6, P7, P8, P9, E> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, E1E<P9, E>>>>>>>>> f1)
    {
