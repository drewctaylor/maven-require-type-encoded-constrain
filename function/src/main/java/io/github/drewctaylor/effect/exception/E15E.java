...
/**
 * A 15-parameter effect that may throw an exception.
 * 
...
public interface E15E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E extends Exception>
{
     ...
     * @throws NullPointerException if e15e is null
     */
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E extends Exception> E15E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E> nop()
    {
        return (
                p1,
                p2,
     ...
     */
    default E14E<P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E> a(
            final P1 p1)
    {
        return (
                p2,
     ...
     */
    default E15E<P15, P14, P13, P12, P11, P10, P9, P8, P7, P6, P5, P4, P3, P2, P1, E> reverse()
    {
        return (
                p15,
                p14,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, F1<P11, F1<P12, F1<P13, F1<P14, E1E<P15, E>>>>>>>>>>>>>>> curry()
    {
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E extends Exception> E15E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, F1<P11, F1<P12, F1<P13, F1<P14, E1E<P15, E>>>>>>>>>>>>>>> f1)
    {
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E extends Exception> E15E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, E> e(
            final E e)
    {
        requireNonNull(e, "e");
        return (
