...
public interface E11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>
{
     ...
     * @throws NullPointerException if e11 is null
     */
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> E11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> nop()
    {
        return (
                p1,
                p2,
     ...
     */
    default E10<P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> a(
            final P1 p1)
    {
        return (
                p2,
     ...
     */
    default E11<P11, P10, P9, P8, P7, P6, P5, P4, P3, P2, P1> reverse()
    {
        return (
                p11,
                p10,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, E1<P11>>>>>>>>>>> curry()
    {
     ...
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> E11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, E1<P11>>>>>>>>>>> f1)
    {
