...
public interface E7<P1, P2, P3, P4, P5, P6, P7>
{
     ...
     */
    default E7<P7, P6, P5, P4, P3, P2, P1> reverse()
    {
        return (
                p7,
                p6,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, E1<P7>>>>>>> curry()
    {
    ...
    static <P1, P2, P3, P4, P5, P6, P7> E7<P1, P2, P3, P4, P5, P6, P7> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, E1<P7>>>>>>> f1)
    {
