 ...
 */
public interface S4<T1, T2, T3, T4>
{
    /**
     ...
     * @param <T4> the type of value 4
     */
    abstract class Default<T1, T2, T3, T4> implements S4<T1, T2, T3, T4>
    {
        private Default()
        {
        }
         ...
         * @param  <T4> the type of value 4
         * 
         * @return      a 4-value sum
         */
        public static final <T1, T2, T3, T4> S4<T1, T2, T3, T4> s4t1(
                final T1 t1)
        {
            return new S4T1<>(t1);
        }
         ...
         * @return      a 4-value sum
         */
        public static final <T1, T2, T3, T4> S4<T1, T2, T3, T4> s4t2(
                final T2 t2)
        {
            return new S4T2<>(t2);
        }
         ...
         * @return      a 4-value sum
         */
        public static final <T1, T2, T3, T4> S4<T1, T2, T3, T4> s4t3(
                final T3 t3)
        {
            return new S4T3<>(t3);
        }
         ...
         * @return      a 4-value sum
         */
        public static final <T1, T2, T3, T4> S4<T1, T2, T3, T4> s4t4(
                final T4 t4)
        {
            return new S4T4<>(t4);
        }

        private static final class S4T1<T1, T2, T3, T4> extends Default<T1, T2, T3, T4>
        {
            private final T1 t1;
        ...
        private static final class S4T2<T1, T2, T3, T4> extends Default<T1, T2, T3, T4>
        {
            private final T2 t2;
        ...
        private static final class S4T3<T1, T2, T3, T4> extends Default<T1, T2, T3, T4>
        {
            private final T3 t3;
        ...
        private static final class S4T4<T1, T2, T3, T4> extends Default<T1, T2, T3, T4>
        {
            private final T4 t4;
