...
import io.github.drewctaylor.effect.E8;
import io.github.drewctaylor.effect.exception.E8E;
import io.github.drewctaylor.function.F8;
import io.github.drewctaylor.function.exception.F8E;
...
public interface P8<T1, T2, T3, T4, T5, T6, T7, T8>
{
     ...
     */
    <R1> R1 match(
            final F8<T1, T2, T3, T4, T5, T6, T7, T8, R1> f);
    ...
    <R1, E extends Exception> R1 matchException(
            final F8E<T1, T2, T3, T4, T5, T6, T7, T8, R1, E> f)
            throws E;
     ...
     */
    void matchEffect(
            final E8<T1, T2, T3, T4, T5, T6, T7, T8> f);
    ...
    <E extends Exception> void matchEffectException(
            final E8E<T1, T2, T3, T4, T5, T6, T7, T8, E> f)
            throws E;

    /**
     * A default 8-value product.
     * 
     * @param <T1> the type of value 1
     * @param <T2> the type of value 2
     * @param <T3> the type of value 3
     ...
     * @param <T8> the type of value 8
     */
    final class Default<T1, T2, T3, T4, T5, T6, T7, T8> implements P8<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        private final T1 v1;
                ...
                final F8<T1, T2, T3, T4, T5, T6, T7, T8, R1> f)
        {
            ...
            return f.f(v1, v2, v3, v4, v5, v6, v7, v8);
        }
         ...
         * @param  <T8> the type of value 8
         * 
         * @return      a 8-value product
         */
        public static <T1, T2, T3, T4, T5, T6, T7, T8> P8<T1, T2, T3, T4, T5, T6, T7, T8> p(
                final T1 v1,
                final T2 v2,
                final T3 v3,
                final T4 v4,
                ...
                final T8 v8)
        {
            return new Default<>(v1, v2, v3, v4, v5, v6, v7, v8);
        }
         ...
         */
        public P8<T8, T7, T6, T5, T4, T3, T2, T1> reverse()
        {
            return P8.reverse(this, Default::new);
        }
    }
}
