...
import io.github.drewctaylor.effect.E13;
import io.github.drewctaylor.effect.exception.E13E;
import io.github.drewctaylor.function.F13;
import io.github.drewctaylor.function.exception.F13E;
 ...
 */
public interface P13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
{
    /**
     ...
     */
    <R1> R1 match(
            final F13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, R1> f);
    ...
    <R1, E extends Exception> R1 matchException(
            final F13E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, R1, E> f)
            throws E;
     ...
     */
    void matchEffect(
            final E13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> f);
    ...
    <E extends Exception> void matchEffectException(
            final E13E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, E> f)
            throws E;

    /**
     * A default 13-value product.
     * 
     * @param <T1>  the type of value 1
     * @param <T2>  the type of value 2
     * @param <T3>  the type of value 3
     ...
     * @param <T13> the type of value 13
     */
    final class Default<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> implements P13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
    {
        private final T1 v1;
                ...
                final F13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, R1> f)
        {
            ...
            return f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13);
        }
                ...
                final E13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> f)
        {
            ...
            f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13);
        }
         ...
         * @param  <T13> the type of value 13
         * 
         * @return       a 13-value product
         */
        public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> P13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> p(
                final T1 v1,
                final T2 v2,
                final T3 v3,
                final T4 v4,
                ...
                final T13 v13)
        {
            return new Default<>(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13);
        }
         ...
         */
        public P13<T13, T12, T11, T10, T9, T8, T7, T6, T5, T4, T3, T2, T1> reverse()
        {
            return P13.reverse(this, Default::new);
        }
    }
}
