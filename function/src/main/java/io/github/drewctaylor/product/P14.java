...
import io.github.drewctaylor.effect.E14;
import io.github.drewctaylor.effect.exception.E14E;
import io.github.drewctaylor.function.F14;
import io.github.drewctaylor.function.exception.F14E;
 ...
 */
public interface P14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
{
    /**
     ...
     */
    <R1> R1 match(
            final F14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, R1> f);
    ...
    <R1, E extends Exception> R1 matchException(
            final F14E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, R1, E> f)
            throws E;
     ...
     */
    void matchEffect(
            final E14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> f);
    ...
    <E extends Exception> void matchEffectException(
            final E14E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, E> f)
            throws E;

    /**
     * A default 14-value product.
     * 
     * @param <T1>  the type of value 1
     * @param <T2>  the type of value 2
     * @param <T3>  the type of value 3
     ...
     * @param <T14> the type of value 14
     */
    final class Default<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> implements P14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
    {
        private final T1 v1;
                ...
                final F14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, R1> f)
        {
            ...
            return f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14);
        }
                ...
                final E14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> f)
        {
            ...
            f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14);
        }
         ...
         * @param  <T14> the type of value 14
         * 
         * @return       a 14-value product
         */
        public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> P14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> p(
                final T1 v1,
                final T2 v2,
                final T3 v3,
                final T4 v4,
                ...
                final T14 v14)
        {
            return new Default<>(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14);
        }
         ...
         */
        public P14<T14, T13, T12, T11, T10, T9, T8, T7, T6, T5, T4, T3, T2, T1> reverse()
        {
            return P14.reverse(this, Default::new);
        }
    }
}
