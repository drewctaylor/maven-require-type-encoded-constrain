...
import io.github.drewctaylor.effect.E7;
import io.github.drewctaylor.effect.exception.E7E;
import io.github.drewctaylor.function.F7;
import io.github.drewctaylor.function.exception.F7E;
...
public interface P7<T1, T2, T3, T4, T5, T6, T7>
{
     ...
     */
    <R1> R1 match(
            final F7<T1, T2, T3, T4, T5, T6, T7, R1> f);
    ...
    <R1, E extends Exception> R1 matchException(
            final F7E<T1, T2, T3, T4, T5, T6, T7, R1, E> f)
            throws E;
     ...
     */
    void matchEffect(
            final E7<T1, T2, T3, T4, T5, T6, T7> f);
    ...
    <E extends Exception> void matchEffectException(
            final E7E<T1, T2, T3, T4, T5, T6, T7, E> f)
            throws E;

    /**
     * A default 7-value product.
     * 
     * @param <T1> the type of value 1
     * @param <T2> the type of value 2
     * @param <T3> the type of value 3
     ...
     * @param <T7> the type of value 7
     */
    final class Default<T1, T2, T3, T4, T5, T6, T7> implements P7<T1, T2, T3, T4, T5, T6, T7>
    {
        private final T1 v1;
                ...
                final F7<T1, T2, T3, T4, T5, T6, T7, R1> f)
        {
            ...
            return f.f(v1, v2, v3, v4, v5, v6, v7);
        }
         ...
         * @param  <T7> the type of value 7
         * 
         * @return      a 7-value product
         */
        public static <T1, T2, T3, T4, T5, T6, T7> P7<T1, T2, T3, T4, T5, T6, T7> p(
                final T1 v1,
                final T2 v2,
                final T3 v3,
                final T4 v4,
                ...
                final T7 v7)
        {
            return new Default<>(v1, v2, v3, v4, v5, v6, v7);
        }
         ...
         */
        public P7<T7, T6, T5, T4, T3, T2, T1> reverse()
        {
            return P7.reverse(this, Default::new);
        }
    }
}
