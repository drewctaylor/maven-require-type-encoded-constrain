...
import io.github.drewctaylor.effect.E10;
import io.github.drewctaylor.effect.exception.E10E;
import io.github.drewctaylor.function.F10;
import io.github.drewctaylor.function.exception.F10E;
 ...
 */
public interface P10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
    /**
     ...
     */
    <R1> R1 match(
            final F10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R1> f);
    ...
    <R1, E extends Exception> R1 matchException(
            final F10E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R1, E> f)
            throws E;
     ...
     */
    void matchEffect(
            final E10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> f);
    ...
    <E extends Exception> void matchEffectException(
            final E10E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> f)
            throws E;

    /**
     * A default 10-value product.
     * 
     * @param <T1>  the type of value 1
     * @param <T2>  the type of value 2
     * @param <T3>  the type of value 3
     ...
     * @param <T10> the type of value 10
     */
    final class Default<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements P10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    {
        private final T1 v1;
                ...
                final F10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R1> f)
        {
            ...
            return f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);
        }
                ...
                final E10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> f)
        {
            ...
            f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);
        }
         ...
         * @param  <T10> the type of value 10
         * 
         * @return       a 10-value product
         */
        public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> P10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> p(
                final T1 v1,
                final T2 v2,
                final T3 v3,
                final T4 v4,
                ...
                final T10 v10)
        {
            return new Default<>(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);
        }
         ...
         */
        public P10<T10, T9, T8, T7, T6, T5, T4, T3, T2, T1> reverse()
        {
            return P10.reverse(this, Default::new);
        }
    }
}
