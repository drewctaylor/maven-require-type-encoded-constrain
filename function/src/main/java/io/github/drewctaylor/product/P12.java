...
import io.github.drewctaylor.effect.E12;
import io.github.drewctaylor.effect.exception.E12E;
import io.github.drewctaylor.function.F12;
import io.github.drewctaylor.function.exception.F12E;
 ...
 */
public interface P12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
{
    /**
     ...
     */
    <R1> R1 match(
            final F12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R1> f);
    ...
    <R1, E extends Exception> R1 matchException(
            final F12E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R1, E> f)
            throws E;
     ...
     */
    void matchEffect(
            final E12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> f);
    ...
    <E extends Exception> void matchEffectException(
            final E12E<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, E> f)
            throws E;

    /**
     * A default 12-value product.
     * 
     * @param <T1>  the type of value 1
     * @param <T2>  the type of value 2
     * @param <T3>  the type of value 3
     ...
     * @param <T12> the type of value 12
     */
    final class Default<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> implements P12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
    {
        private final T1 v1;
                ...
                final F12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R1> f)
        {
            ...
            return f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12);
        }
                ...
                final E12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> f)
        {
            ...
            f.f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12);
        }
         ...
         * @param  <T12> the type of value 12
         * 
         * @return       a 12-value product
         */
        public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> P12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> p(
                final T1 v1,
                final T2 v2,
                final T3 v3,
                final T4 v4,
                ...
                final T12 v12)
        {
            return new Default<>(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12);
        }
         ...
         */
        public P12<T12, T11, T10, T9, T8, T7, T6, T5, T4, T3, T2, T1> reverse()
        {
            return P12.reverse(this, Default::new);
        }
    }
}
