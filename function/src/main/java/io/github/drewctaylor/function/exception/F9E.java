...
public interface F9E<P1, P2, P3, P4, P5, P6, P7, P8, P9, R1, E extends Exception>
{
    ...
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, R1, E extends Exception> F9E<P1, P2, P3, P4, P5, P6, P7, P8, P9, R1, E> constant(
            final R1 r1)
    {
        return (
                p1,
    ...
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, R1, E extends Exception> F9E<P1, P2, P3, P4, P5, P6, P7, P8, P9, R1, E> exception(
            final E e)
    {
        requireNonNull(e, "e");
        return (
    ...
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, E extends Exception> F9E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P1, E> identity()
    {
        return (
                p1,
                p2,
