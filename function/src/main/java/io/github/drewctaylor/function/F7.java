...
public interface F7<P1, P2, P3, P4, P5, P6, P7, R1>
{
     ...
     */
    default F7<P7, P6, P5, P4, P3, P2, P1, R1> reverse()
    {
        return (
                p7,
                p6,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, R1>>>>>>> curry()
    {
    ...
    static <P1, P2, P3, P4, P5, P6, P7, R1> F7<P1, P2, P3, P4, P5, P6, P7, R1> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, R1>>>>>>> f1)
    {
