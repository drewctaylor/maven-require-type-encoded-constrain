...
public interface F5<P1, P2, P3, P4, P5, R1>
{
     ...
     * @throws NullPointerException if f5 is null
     */
     ...
     */
    static <P1, P2, P3, P4, P5> F5<P1, P2, P3, P4, P5, P1> c()
    {
        return (
                p1,
                p2,
     ...
     */
    default F5<P5, P4, P3, P2, P1, R1> reverse()
    {
        return (
                p5,
                p4,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, R1>>>>> curry()
    {
     ...
     */
    static <P1, P2, P3, P4, P5, R1> F5<P1, P2, P3, P4, P5, R1> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, R1>>>>> f1)
    {
     ...
     * @throws NullPointerException if f1 is null
     */
    default <R2> F5<P1, P2, P3, P4, P5, R2> then(
            final F1<R1, R2> f1)
    {
        requireNonNull(f1, "f1");
        return (
     ...
     */
    static <P1, P2, P3, P4, P5, R1> F5<P1, P2, P3, P4, P5, R1> c(
            final R1 r1)
    {
        return (
                p1,
