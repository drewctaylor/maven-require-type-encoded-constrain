...
/**
 * A 12-parameter function that may throw an exception.
 * 
...
public interface F12E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, R1, E extends Exception>
{
     ...
     */
    default F12E<P12, P11, P10, P9, P8, P7, P6, P5, P4, P3, P2, P1, R1, E> reverse()
    {
        return (
                p12,
                p11,
     ...
     */
    default F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, F1<P11, F1E<P12, R1, E>>>>>>>>>>>> curry()
    {
    ...
    static <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, R1, E extends Exception> F12E<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, R1, E> uncurry(
            final F1<P1, F1<P2, F1<P3, F1<P4, F1<P5, F1<P6, F1<P7, F1<P8, F1<P9, F1<P10, F1<P11, F1E<P12, R1, E>>>>>>>>>>>> f1)
    {
