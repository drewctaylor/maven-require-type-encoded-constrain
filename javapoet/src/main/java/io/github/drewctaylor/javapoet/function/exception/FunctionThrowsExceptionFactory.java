...
import static io.github.drewctaylor.javapoet.JavaPoetUtility.className;
...
public final class FunctionThrowsExceptionFactory
{
            ...
            final String parameterCountString)
    {
        ...
        return range(0, parameterCount + 1)
                .mapToObj(FunctionThrowsExceptionDescriptor::new)
                .map(FunctionThrowsExceptionFactory::javaFile)
                .collect(toList());
    }

    private static JavaFile javaFile(
            final FunctionThrowsExceptionDescriptor descriptor)
    {
