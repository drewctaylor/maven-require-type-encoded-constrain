...
// parameterSpecList.stream().map(parameterSpec -> parameterJavadoc(parameterSpec,
// parameterSpecCodeBlockMap.get(parameterSpec)))),
// typeVariableNameList.stream().map(typeVariableName -> typeVariableJavadoc(typeVariableName,
// typeVariableNameCodeBlockMap.get(typeVariableName)))),
// codeBlockReturn.stream()),
// exceptionTypeNameList.stream().flatMap(exceptionTypeName ->
// exceptionTypeNameCodeBlockMap.get(exceptionTypeName).stream().map(exceptionCodeBlock ->
// throwsJavadoc(exceptionTypeName, exceptionCodeBlock))))
...
// this.parameterSpecCodeBlockMap.putAll(range(0,
// parameterSpecList.size()).boxed().collect(Collectors.toMap(parameterSpecList::get, parameterSpecIndex ->
// CodeBlock.of(parameterSpecIntegerCodeBlockStringBiFunction.apply(parameterSpecList.get(parameterSpecIndex),
// parameterSpecIndex)))));
//
// return this;
//
...
// this.parameterSpecCodeBlockMap.putAll(range(0,
// parameterSpecList.size()).boxed().collect(Collectors.toMap(parameterSpecList::get, parameterSpecIndex ->
// parameterSpecIntegerCodeBlockBiFunction.apply(parameterSpecList.get(parameterSpecIndex), parameterSpecIndex))));
//
// return this;
// }
//
...
// this.typeVariableNameCodeBlockMap.putAll(range(0,
// typeVariableNameList.size()).boxed().collect(Collectors.toMap(typeVariableNameList::get, typeVariableNameIndex ->
// typeVariableNameIntegerCodeBlockBiFunction.apply(typeVariableNameList.get(typeVariableNameIndex),
// typeVariableNameIndex))));
//
// return this;
// }
//
...
// this.typeVariableNameCodeBlockMap.putAll(range(0,
// typeVariableNameList.size()).boxed().collect(Collectors.toMap(typeVariableNameList::get, typeVariableNameIndex ->
// CodeBlock.of(typeVariableNameIntegerCodeBlockStringBiFunction.apply(typeVariableNameList.get(typeVariableNameIndex),
// typeVariableNameIndex)))));
//
// return this;
// }
...
// this.exceptionTypeNameCodeBlockMap.put(ClassName.get(exceptionClass), List.of(CodeBlock.of(codeBlockString)));
// }
// else
// {
...
// {
// this.exceptionTypeNameList.add(ClassName.get(exceptionClass));
// this.exceptionTypeNameCodeBlockMap.put(ClassName.get(exceptionClass),
// codeBlockStringList.stream().map(CodeBlock::of).collect(Collectors.toUnmodifiableList()));
// }
// else
// {
// this.exceptionTypeNameCodeBlockMap.get(ClassName.get(exceptionClass)).addAll(codeBlockStringList.stream().map(CodeBlock::of).collect(Collectors.toUnmodifiableList()));
// }
//
// return this;
// }
...
// this.exceptionTypeNameCodeBlockMap.put(exceptionTypeName, List.of(CodeBlock.of(codeBlockString)));
// }
// else
// {
...
// {
// this.exceptionTypeNameList.add(exceptionTypeName);
// this.exceptionTypeNameCodeBlockMap.put(exceptionTypeName,
// codeBlockStringList.stream().map(CodeBlock::of).collect(Collectors.toUnmodifiableList()));
// }
// else
// {
// this.exceptionTypeNameCodeBlockMap.get(exceptionTypeName).addAll(codeBlockStringList.stream().map(CodeBlock::of).collect(Collectors.toUnmodifiableList()));
// }
//
// return this;
// }
...
// {
// this.exceptionTypeNameList.add(exceptionTypeName);
// this.exceptionTypeNameCodeBlockMap.put(exceptionTypeName, List.of(codeBlock));
// }
// else
// {
...
//
// exceptionTypeNameCodeBlockStringMap.keySet().stream().forEach(exceptionTypeName ->
// addThrowsWithStringDescription(exceptionTypeName, exceptionTypeNameCodeBlockStringMap.get(exceptionTypeName)));
//
// return this;
// }
//
...
//
// exceptionTypeNameCodeBlockMap.keySet().stream().forEach(exceptionTypeName -> addThrows(exceptionTypeName,
// exceptionTypeNameCodeBlockMap.get(exceptionTypeName)));
//
// return this;
// }
//
...
//
// range(0, exceptionTypeNameList.size()).boxed().forEach(typeNameIndex ->
// addThrows(exceptionTypeNameList.get(typeNameIndex),
// exceptionTypeNameIntegerCodeBlockStringBiFunction.apply(exceptionTypeNameList.get(typeNameIndex),
// typeNameIndex).stream().map(CodeBlock::of).collect(Collectors.toList())));
//
// return this;
// }
//
...
// range(0, exceptionTypeNameList.size()).boxed().forEach(typeNameIndex ->
// addThrows(exceptionTypeNameList.get(typeNameIndex),
// exceptionTypeNameIntegerCodeBlockBiFunction.apply(exceptionTypeNameList.get(typeNameIndex), typeNameIndex)));
//
// return this;
// }
//
